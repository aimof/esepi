...
var questions = []Question{
	// コピー＆ペーストの能力を見る
	Question{
		Question:  "以下の数字を回答欄に入力し、送信ボタンを押しなさい。",
		Resources: "3.14159265359",
		Answer:    "3.14159265359",
	},
	// ブラウザ内検索。夏目漱石、こころ 青空文庫: https://www.aozora.gr.jp/cards/000148/card773.html
	Question{
		Question: "現在表示されているWebページにおいて10番目の「ま」の直前の一文字を抜き出し、回答欄に入力し、送信ボタンを押しなさい。",
		Resources: `　私《わたくし》はその人を常に先生と呼んでいた。だからここでもただ先生と書くだけで本名は打ち明けない。これは世間を憚《はば》かる遠慮というよりも、その方が私にとって自然だからである。私はその人の記憶を呼び起すごとに、すぐ「先生」といいたくなる。筆を執《と》っても心持は同じ事である。よそよそしい頭文字《かしらもじ》などはとても使う気にならない。
...
　私は実に先生をこの雑沓《ざっとう》の間《あいだ》に見付け出したのである。その時海岸には掛茶屋《かけぢゃや》が二軒あった。私はふとした機会《はずみ》からその一軒の方に行き慣《な》れていた。長谷辺《はせへん》に大きな別荘を構えている人と違って、各自《めいめい》に専有の着換場《きがえば》を拵《こしら》えていないここいらの避暑客には、ぜひともこうした共同着換所といった風《ふう》なものが必要なのであった。彼らはここで茶を飲み、ここで休息する外《ほか》に、ここで海水着を洗濯させたり、ここで鹹《しお》はゆい身体《からだ》を清めたり、ここへ帽子や傘《かさ》を預けたりするのである。海水着を持たない私にも持物を盗まれる恐れはあったので、私は海へはいるたびにその茶屋へ一切《いっさい》を脱《ぬ》ぎ棄《す》てる事にしていた。`,
	...
	// 検索エンジンの電卓機能
	Question{
		Question:  "以下の数式を計算し、回答欄に入力し、送信ボタンを押しなさい。",
		Resources: "(773*256*367-10000000)/2",
		Answer:    "31312448",
	},
}
